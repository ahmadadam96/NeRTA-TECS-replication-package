    ...
    class Pmw3901OpticalFlow : public Sensor, public PMW3901 {
        ...
        protected:
            ...
            virtual void modifyState(State * state, float time) override
            {
                ...
                state->x[State::DX] = deltaX;
                state->x[State::DY] = deltaY;
            ...
            virtual bool ready(Board* board) override
            {
        ...
        public:
         Pmw3901OpticalFlow(uint8_t cspin, SPIClass* spi = &SPI, uint16_t freq = 50)
             : PMW3901(cspin, spi)
         {
             _period = 1. / freq;

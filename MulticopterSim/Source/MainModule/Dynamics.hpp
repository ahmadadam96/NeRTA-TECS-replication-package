...
class Dynamics {
    ...
    protected:
        ...
        void bodyZToInertial(double bodyZ,
                                    ...
                                    double inertial[3])
        {
            ...
            static double start_time = FPlatformTime::Seconds();

            double current_time = FPlatformTime::Seconds();
            // test a 1 N force applied in the y direction.
            //if (current_time - start_time > 10.0 && current_time - start_time < 11.0) inertial[1] += 1.0/_vparams.m;
        }
